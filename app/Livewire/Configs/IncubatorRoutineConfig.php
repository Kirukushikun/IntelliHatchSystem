...
class IncubatorRoutineConfig
{
    public static function getRules(): array
    {
        return [
            ...
            'hatchery_man' => 'required|array|min:1',
            'hatchery_man.*' => 'integer|exists:users,id',
    ...
    public static function getMessages(): array
    {
        return [
            ...
            'hatchery_man.required' => 'Please select at least one hatchery man.',
            'hatchery_man.min' => 'Please select at least one hatchery man.',
