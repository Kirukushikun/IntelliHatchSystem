...
use App\Livewire\Configs\IncubatorEntranceTempConfig;
...
class IncubatorEntranceTempForm extends FormNavigation
{
    ...
    public function mount($formType = 'incubator_entrance_temp'): void
    {
        $this->form = IncubatorEntranceTempConfig::defaultFormState();
    ...
    {
        return 'incubator_entrance_temp';
    }

    protected function scheduleConfig(): array
    {
        return IncubatorEntranceTempConfig::schedule();
    }

    protected function stepFieldMap(): array
    {
        return IncubatorEntranceTempConfig::stepFieldMap();
    }

    protected function formTypeName(): string
    {
        return IncubatorEntranceTempConfig::getFormTypeName();
    }

    protected function messages(): array
    {
        return IncubatorEntranceTempConfig::getMessages();
    }
    ...
    public function submitForm()
    {
        ...
        try {
            $this->validate(IncubatorEntranceTempConfig::getRules(), $this->messages());
            ...
            return redirect()->route('forms.incubator-entrance-temp');
    ...
    {
        return view('livewire.shared.forms.incubator-entrance-temp-form');
    }
}
