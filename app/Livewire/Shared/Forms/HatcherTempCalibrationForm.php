...
use App\Livewire\Configs\HatcherTempCalibrationConfig;
...
class HatcherTempCalibrationForm extends FormNavigation
{
    ...
    public function mount($formType = 'hatcher_temp_calibration'): void
    {
        $this->form = HatcherTempCalibrationConfig::defaultFormState();
    ...
    {
        return 'hatcher_temp_calibration';
    }

    protected function scheduleConfig(): array
    {
        return HatcherTempCalibrationConfig::schedule();
    }

    protected function stepFieldMap(): array
    {
        return HatcherTempCalibrationConfig::stepFieldMap();
    }

    protected function formTypeName(): string
    {
        return HatcherTempCalibrationConfig::getFormTypeName();
    }

    protected function messages(): array
    {
        return HatcherTempCalibrationConfig::getMessages();
    }
    ...
    public function submitForm()
    {
        ...
        try {
            $this->validate(HatcherTempCalibrationConfig::getRules(), $this->messages());
            ...
            return redirect()->route('forms.hatcher-temp-calibration');
    ...
    {
        return view('livewire.shared.forms.hatcher-temp-calibration-form');
    }
}
