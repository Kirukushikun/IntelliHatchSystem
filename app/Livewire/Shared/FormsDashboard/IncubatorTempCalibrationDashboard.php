...
class IncubatorTempCalibrationDashboard extends Component
{
    use WithPagination;
    ...
    private function getFormPhotos(int $formId, string $field = null): array
    {
        try {
            ...
            $photoFields = ['reading_photos', 'humidity_photos'];
    ...
    public function render()
    {
        ...
        return view('livewire.shared.forms-dashboard.incubator-temp-calibration-dashboard', [
