...
class HatcherMachineAccuracyDashboard extends Component
{
    use WithPagination;
    ...
    {
        $this->formType = FormType::where('form_name', 'Hatcher Machine Accuracy Temperature Checking')->where('isActive', true)->firstOrFail();
    ...
    public function render()
    {
        ...
        return view('livewire.shared.forms-dashboard.hatcher-machine-accuracy-dashboard', [
