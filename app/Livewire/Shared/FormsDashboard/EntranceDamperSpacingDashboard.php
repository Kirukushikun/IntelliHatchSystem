...
class EntranceDamperSpacingDashboard extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.shared.forms-dashboard.entrance-damper-spacing-dashboard', [
