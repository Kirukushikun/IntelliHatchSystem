...
class BlowerAirIncubatorDashboard extends Component
{
    ...
    {
        $this->formType = FormType::where('form_name', 'Incubator Blower Air Speed Monitoring')->where('isActive', true)->firstOrFail();
    ...
    public function render()
    {
        ...
        return view('livewire.shared.forms-dashboard.blower-air-incubator-dashboard', [
