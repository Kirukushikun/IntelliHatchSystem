...
class IncubatorEntranceTempDashboard extends Component
{
    use WithPagination;
    ...
    private function getFormPhotos(int $formId, string $field = null): array
    {
        try {
            ...
            $photoFields = ['entrance_photo', 'baggy_photo', 'temp_adjustment_photo'];
    ...
    public function render()
    {
        ...
        return view('livewire.shared.forms-dashboard.incubator-entrance-temp-dashboard', [
