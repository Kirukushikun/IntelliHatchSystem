...
class PlenumTempHumidityDashboard extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.shared.forms-dashboard.plenum-temp-humidity-dashboard', [
