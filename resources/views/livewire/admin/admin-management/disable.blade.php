                ...
                <div class="flex items-center mb-4">
                    <div class="shrink-0 w-12 h-12 {{ $isCurrentlyDisabled ? 'bg-green-100' : 'bg-red-100' }} rounded-full flex items-center justify-center">
                        @if($isCurrentlyDisabled)
                            <svg width="24" height="24" viewBox="0 0 15 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-green-600">
                        ...
                        @else
                            <svg width="24" height="24" viewBox="0 0 48 48" version="1" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 text-red-600">
