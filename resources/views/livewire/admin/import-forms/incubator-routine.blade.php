<div>
    ...
    @if ($step === 2)
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-4 text-center">
                <p class="text-2xl font-bold {{ count($unmatchedNames) > 0 ? 'text-orange-600 dark:text-orange-400' : 'text-green-600 dark:text-green-400' }}">{{ count($userMapping) }}</p>
                <p class="text-sm text-gray-500 dark:text-gray-400">Unique Hatcherymen</p>
                @if (count($unmatchedNames) > 0)
                    <p class="text-xs text-orange-500 dark:text-orange-400">{{ count($unmatchedNames) }} need mapping</p>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-md dark:shadow-lg rounded-lg p-6 mb-6">
            ...
            <div class="space-y-3">
                @foreach ($userMapping as $name => $userId)
                    <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 p-3 rounded-lg {{ empty($userId) ? 'bg-orange-50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-800' : 'bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800' }}">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select
                                wire:model.live="userMapping.{{ $name }}"
