<div>
    ...
    <!-- Table Section -->
    <div wire:poll.120s.visible class="relative flex flex-col w-full h-full text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 shadow-md dark:shadow-lg rounded-lg bg-clip-border">
        <!-- Desktop Table View -->
