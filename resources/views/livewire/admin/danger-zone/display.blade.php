                ...
                <div class="px-6 py-6">
                    ...
                    <div class="flex gap-3 justify-center">
                        ...
                        <button wire:click="confirmWipe"
                            ...
                            <span wire:loading.remove wire:target="confirmWipe">Delete {{ number_format($affectedCount) }} Submissions</span>
                ...
                <div class="px-6 py-6">
                    ...
                    <div class="flex gap-3 justify-center">
                        ...
                        <button wire:click="confirmLogWipe"
                            ...
                            <span wire:loading.remove wire:target="confirmLogWipe">Purge {{ number_format($logAffectedCount) }} Entries</span>
