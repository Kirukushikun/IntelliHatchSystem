            ...
            <div class="relative w-full max-w-md p-6 bg-white shadow-xl rounded-lg">
                ...
                <form wire:submit.prevent="createUser">
                    ...
                    <div class="flex justify-end space-x-3">
                        ...
                        >
                            <svg wire:loading.remove wire:target="createUser" class="w-0 h-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            </svg>
                            <svg wire:loading wire:target="createUser" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
