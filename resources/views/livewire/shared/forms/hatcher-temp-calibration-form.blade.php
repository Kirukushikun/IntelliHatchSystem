        ...
        >
            <div data-step="1" class="space-y-4" @style(["display:none" => $currentStep !== 1])>
                ...
                <div data-field="machine_temp_set_point">
                    <x-text-input label="Hatcher Machine Temperature Set Point" name="machine_temp_set_point" error-key="form.machine_temp_set_point" :required="true" placeholder="e.g. 99.5" wireModel="form.machine_temp_set_point" type="number" step="0.01" />
                </div>
            </div>
