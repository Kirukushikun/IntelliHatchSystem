...
<div wire:key="{{ now()->timestamp }}">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-6">
        ...
        <div class="relative w-full sm:w-auto sm:shrink-0">
            ...
            />
            <a
                href="{{ \Illuminate\Support\Facades\URL::temporarySignedRoute('admin.print.forms.blower-air-hatcher', now()->addMinutes(10), ['search' => $search, 'dateFrom' => $dateFrom, 'dateTo' => $dateTo, 'sortField' => $sortField, 'sortDirection' => $sortDirection]) }}"
                target="_blank"
                rel="noopener"
            ...
            @forelse($forms as $form)
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm dark:shadow-lg p-4 space-y-3 mb-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between">
                            <span class="text-xs font-medium text-gray-500 dark:text-gray-400">Hatcher:</span>
