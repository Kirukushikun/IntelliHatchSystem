                ...
                @if($this->selectedForm)
                    ...
                    <div class="mb-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="flex justify-between items-center py-2 border-b border-gray-100 bg-white">
                                <span class="text-sm font-medium text-gray-600">Hatcher:</span>
                                <span class="text-sm text-gray-900">{{ $this->machine_info['name'] ?? 'N/A' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 space-y-3">
                            ...
                            <div class="py-2 bg-gray-50">
                                <div class="flex justify-between items-center">
                                    <span class="text-sm font-medium text-gray-600">Action Taken:</span>
                                    <div class="flex items-center gap-2">
                                        {!! getPhotoButton('cfm_fan_action_taken', $this) !!}
                                    </div>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-md">
                                    <p class="text-sm text-gray-700">{{ $this->formData['cfm_fan_action_taken'] ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
