                ...
                @if($this->selectedForm)
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700"><span class="text-sm font-medium text-gray-600 dark:text-gray-400">Wet Bulb:</span><span class="text-sm text-gray-900 dark:text-gray-200">{{ $this->formData['wet_bulb'] ?? 'N/A' }}</span></div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700"><span class="text-sm font-medium text-gray-600 dark:text-gray-400">Dry Bulb:</span><span class="text-sm text-gray-900 dark:text-gray-200">{{ $this->formData['dry_bulb'] ?? 'N/A' }}</span></div>
