            ...
            <div class="bg-white dark:bg-gray-800 px-4 py-3 border-b border-gray-200 dark:border-gray-700 sm:px-6">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-white">
                        INCUBATOR AIR SPEED WEEKLY MONITORING
                    </h3>
                    <button type="button"
                ...
                @if($this->selectedForm)
                    ...
                    <div class="mb-8">
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700">
                                <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Incubator No.:</span>
                        ...
                        <div class="mt-6 space-y-4">
                            @php
                                $readings = [
                                    ['key' => 'left_baggy_top_reading', 'photo_key' => 'left_baggy_top_photos', 'label' => 'Left Baggy - Top'],
                                    ['key' => 'left_baggy_middle_reading', 'photo_key' => 'left_baggy_middle_photos', 'label' => 'Left Baggy - Middle'],
                                    ['key' => 'left_baggy_bottom_reading', 'photo_key' => 'left_baggy_bottom_photos', 'label' => 'Left Baggy - Bottom'],
                                    ['key' => 'right_baggy_top_reading', 'photo_key' => 'right_baggy_top_photos', 'label' => 'Right Baggy - Top'],
                                    ['key' => 'right_baggy_middle_reading', 'photo_key' => 'right_baggy_middle_photos', 'label' => 'Right Baggy - Middle'],
                                    ['key' => 'right_baggy_bottom_reading', 'photo_key' => 'right_baggy_bottom_photos', 'label' => 'Right Baggy - Bottom'],
                                ];
                            @endphp
                            ...
                            @foreach($readings as $reading)
                                <div class="py-3 border-b border-gray-100 dark:border-gray-700">
                                    <div class="flex justify-between items-center mb-2">
                                        <span class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ $reading['label'] }} - Airspeed Reading:</span>
                                        <div class="flex items-center gap-2">
                                            {!! getPhotoButton($reading['photo_key'], $this) !!}
                                        </div>
                                    </div>
                                    <div class="p-4 rounded-md bg-gray-50 dark:bg-gray-700">
                                        <p class="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{{ $this->formData[$reading['key']] ?? 'N/A' }}</p>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="py-3 border-b border-gray-100 dark:border-gray-700">
                                <div class="flex justify-between items-center mb-2">
                                    <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Remarks:</span>
                                </div>
                                <div class="p-4 rounded-md bg-gray-50 dark:bg-gray-700">
                                    <p class="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{{ $this->formData['remarks'] ?? 'N/A' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
