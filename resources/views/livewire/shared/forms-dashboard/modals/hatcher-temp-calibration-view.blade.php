        ...
        <div x-show="showModal"
            ...
            <div class="bg-white dark:bg-gray-800 px-6 py-3 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">HATCHER TEMPERATURE CALIBRATION</h3>
            ...
            <div class="bg-white dark:bg-gray-800 px-6 py-4 max-h-[70vh] overflow-y-auto">
                @if($this->selectedForm)
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700"><span class="text-sm font-medium text-gray-600 dark:text-gray-400">Approver:</span><span class="text-sm text-gray-900 dark:text-gray-200">{{ $this->formData['approver'] ?? 'N/A' }}</span></div>
                    </div>
                    <div class="mb-6">
                    ...
                    <div>
                        <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wide mb-4">Calibration Readings</h4>
                        <div class="space-y-4">
                            <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700"><span class="text-sm font-medium text-gray-600 dark:text-gray-400">Machine Temp:</span><span class="text-sm text-gray-900 dark:text-gray-200">{{ $this->formData['machine_temp'] ?? 'N/A' }}</span></div>
                            <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700"><span class="text-sm font-medium text-gray-600 dark:text-gray-400">Calibrator Temp:</span><span class="text-sm text-gray-900 dark:text-gray-200">{{ $this->formData['calibrator_temp'] ?? 'N/A' }}</span></div>
                            <div class="py-3 border-b border-gray-100 dark:border-gray-700">
                                <div class="flex justify-between items-center mb-2">
                                    <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Reading Photos:</span>
                                    @php $photoCount = $this->getPhotoCount('reading_photos'); @endphp
                                    @if($photoCount > 0)
                                        <button @click="$wire.viewPhotos('reading_photos')" class="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-semibold rounded-lg border border-blue-200 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 hover:bg-blue-100 transition-all cursor-pointer">Photos ({{ $photoCount }})</button>
                                    @else
                            ...
                            <div class="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700"><span class="text-sm font-medium text-gray-600 dark:text-gray-400">Humidity Reading:</span><span class="text-sm text-gray-900 dark:text-gray-200">{{ $this->formData['humidity_reading'] ?? 'N/A' }}</span></div>
                            <div class="py-3 border-b border-gray-100 dark:border-gray-700">
                                <div class="flex justify-between items-center mb-2">
                                    <span class="text-sm font-medium text-gray-600 dark:text-gray-400">Humidity Photos:</span>
                                    @php $photoCount = $this->getPhotoCount('humidity_photos'); @endphp
                                    @if($photoCount > 0)
                                        <button @click="$wire.viewPhotos('humidity_photos')" class="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-semibold rounded-lg border border-blue-200 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 hover:bg-blue-100 transition-all cursor-pointer">Photos ({{ $photoCount }})</button>
                                    @else
                                        <span class="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-600">No Photos</span>
                                    @endif
                                </div>
