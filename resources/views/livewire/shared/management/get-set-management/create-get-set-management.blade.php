        ...
        <div class="fixed inset-0 z-9999 flex items-center justify-center p-4" wire:ignore.self>
            ...
            <div class="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-xl dark:shadow-2xl rounded-lg">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Add New GetSet</h3>
                ...
                <form wire:submit.prevent="createGetSet">
                    <div class="space-y-4">
                        <div>
                            <x-text-input
                                label="GetSet Name"
                                ...
                                name="getSetName"
                                type="text"
                                :wireModel="'getSetName'"
                                placeholder="Enter get-set name"
                                required
                            />
                        </div>
                    </div>
