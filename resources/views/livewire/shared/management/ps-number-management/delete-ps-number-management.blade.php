        ...
        <div class="fixed inset-0 z-9999 flex items-center justify-center p-4" wire:ignore.self>
            ...
            <div class="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-xl dark:shadow-2xl rounded-lg">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Delete PS Number</h3>
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-900 dark:text-white">Are you sure you want to delete {{ $psNumber }}?</p>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <x-button
                        variant="danger"
                        size="sm"
                        wire:click="deletePsNumber"
                        wire:loading.attr="disabled"
                        wire:target="deletePsNumber"
                    >
                        <span wire:loading.remove wire:target="deletePsNumber">Delete PS Number</span>
                        <span wire:loading wire:target="deletePsNumber">Deleting...</span>
                    </x-button>
                </div>
            </div>
        </div>
