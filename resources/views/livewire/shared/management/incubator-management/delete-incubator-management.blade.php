        ...
        <div class="fixed inset-0 z-9999 flex items-center justify-center p-4" wire:ignore.self>
            ...
            <div class="relative w-full max-w-md p-6 bg-white dark:bg-gray-800 shadow-xl dark:shadow-2xl rounded-lg">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Delete Incubator</h3>
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-900 dark:text-white">Are you sure you want to delete {{ $incubatorName }}?</p>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <x-button 
                        variant="danger" 
                        size="sm" 
                        wire:click="deleteIncubator"
                        wire:loading.attr="disabled"
                        wire:target="deleteIncubator"
                    >
                        <span wire:loading.remove wire:target="deleteIncubator">Delete Incubator</span>
                        <span wire:loading wire:target="deleteIncubator">Deleting...</span>
                    </x-button>
                </div>
            </div>
        </div>
