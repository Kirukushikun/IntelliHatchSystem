                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        <label class="flex items-center">
                                            ...
                                            <span class="text-sm text-gray-700">All Incubators</span>
                                        </label>
                                        <label class="flex items-center">
            ...
            @forelse ($incubators as $incubator)
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-4 space-y-3">
                    <div class="flex justify-between items-start">
                        <div class="space-y-1">
                            <p class="text-sm font-semibold text-gray-900">{{ $incubator->incubatorName }}</p>
                            <p class="text-xs text-gray-500">{{ $incubator->creationDate->format('M d, Y') }}</p>
                        </div>
