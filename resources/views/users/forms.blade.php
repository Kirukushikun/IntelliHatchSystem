    ...
    @php
        $forms = [
            [
                ...
                'route' => route('user.forms.incubator-routine'),
                'color' => 'amber',
            ]
        ];
            ...
            <div class="flex items-center justify-between gap-6">
                ...
                <div class="relative shrink-0">
                    ...
                    <input
                        ...
                        class="w-80 pl-11 pr-4 py-3 text-sm bg-white border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all placeholder:text-gray-400 shadow-sm"
                    />
                </div>
            </div>
